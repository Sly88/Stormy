...
import com.sylwestermichalowski.stormy.wather.Current;
import com.sylwestermichalowski.stormy.wather.Day;
import com.sylwestermichalowski.stormy.wather.Forecast;
import com.sylwestermichalowski.stormy.wather.Hour;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateDisplay() {
        ...
        mTimeLabel.setText("At " + current.getForrmatedTime() + " it will be");
    ...
    private Current getCurrentDetails(String jsonData) throws  JSONException
    {
        ...
        Log.d(TAG, current.getForrmatedTime());
    ...
    private Hour[] getHourlyForecast(String jsonData) throws JSONException{
        ...
        for(int i = 0; i < data.length(); i++)
        {
            ...
            hour.setTeperature(jsonHour.getDouble("temperature"));
